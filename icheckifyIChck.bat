...
call aws s3 cp .\app\build\outputs\apk\release\app-release_%SUBFILENAME%_dev.apk s3://ickeckify-apk/demo/ --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers full=emailaddress=ajeetkumar@email.com
