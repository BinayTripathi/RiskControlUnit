...
const AudioPreview = ({path, audioLength}) => {
        ...
        <View style={styles.container}>
            <View style={styles.viewPlayer}>
                ...
                <View style={styles.playBtnWrapper}>
                    ...
                    <Button style={[ styles.btn, {marginLeft: 12}]} onPress={onPausePlay} textStyle={styles.txt}  title= "PAUSE"> Pause  </Button>
                    <Button style={[ styles.btn, { marginLeft: 12}]} onPress={onResumePlay} textStyle={styles.txt}  title= "RESUME">  Resume </Button>
